							...
							<div class="modal-body">
								<div class="row">
									...
									<div class="col-md-8 col-sm-8">
										...
										<p class="info"><sub><span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span> {{selected.vote_count}}</sub>  <sub><span class="glyphicon glyphicon-fire" aria-hidden="true"></span> {{selected.popularity}}</sub>  <sub class="pull-right"><strong>R</strong></sub></p>
									</div>
								</div>
